...
class Stats
{
	public static function countOfferedProgram(){
		$kira = Program::find()
		->where(['faculty_id' => 16, 'status' => 1, 'trash' => 0])
		->count();
		return $kira;
	}
	...
	public static function countUDProgram(){
		$kira = Program::find()
		->where(['faculty_id' => 16, 'status' => 0, 'trash' => 0])
		->count();
		return $kira;
	}
	...
	public static function countPublishedCourses(){
		...
		->where(['faculty_id' => 16, 'is_active' => 1, 'is_published' => 1])
		->count();
		return $kira;
	}
	...
	public static function countUDCourses(){
		$kira = Course::find()
		->joinWith(['courseVersion'])
		->where(['faculty_id' => 16, 'is_active' => 1, 'is_developed' => 1])
		->count();
		return $kira;
	}
	...
	public static function countUDStatus($status){
		$kira = Course::find()
		->joinWith(['courseVersion'])
		->where(['faculty_id' => 16 'is_active' => 1, 'is_developed' => 1, 'status' => $status])
		->count();
		return $kira;
	}
	...
	public static function courseByProgram(){
		...
		->joinWith(['program'])
		->where(['sp_course.faculty_id' => 13, 'is_active' => 1])
